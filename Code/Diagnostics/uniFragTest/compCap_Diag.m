% compCap_Diag: for a uniform draw from the P(DS) distribution (PMF), return the
% damage state and traffic capacity (DIAGNOSTICS)
%
% INPUTS
...
function [ratio,DS]=compCap_Diag(DSlims,draw)
